...
public interface OrderInfoRepository extends JpaRepository<OrderInfo, Long> {
    ...
    @Query("select o from OrderInfo o where " +
            "o.orderState = com.example.heroku.entity.order.PaymentState.PAYMENT_CONFIRM or " +
            "o.orderState = com.example.heroku.entity.order.PaymentState.WRITE_REVIEW or " +
            "o.orderState = com.example.heroku.entity.order.PaymentState.PART_WRITE_REVIEW  or " +
            "o.orderState = com.example.heroku.entity.order.PaymentState.ABLE_WRITE_REVIEW ")
